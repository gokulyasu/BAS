		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#expensetracker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"expensetracker-display": {
								"semanticObject": "expensetracker",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=expensetracker",
									"url": sap.ui.require.toUrl("expensetracker")
								}
							}
						}
					}
